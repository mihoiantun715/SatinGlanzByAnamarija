        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12">
          ...
          <div className="prose prose-gray max-w-none space-y-6 text-gray-700">
            ...
            <section>
              ...
              <p className="mt-4">2.3 Der Verkäufer kann das Angebot des Kunden innerhalb von fünf Tagen annehmen, indem er dem Kunden eine schriftliche Auftragsbestätigung oder eine Auftragsbestätigung in Textform (Fax oder E-Mail) übermittelt, wobei insoweit der Zugang der Auftragsbestätigung beim Kunden maßgeblich ist, oder indem er dem Kunden die bestellte Ware liefert, wobei insoweit der Zugang der Ware beim Kunden maßgeblich ist.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">3.3 Dem Kunden stehen verschiedene Zahlungsmöglichkeiten zur Verfügung, die im Online-Shop des Verkäufers angegeben werden.</p>
              
              <p className="mt-4">3.4 Bei Auswahl der Zahlungsart Kreditkarte erfolgt die Zahlungsabwicklung über den Zahlungsdienstleister Stripe. Der Verkäufer behält sich vor, einzelne Zahlungsarten auszuschließen.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">4.3 Die Lieferzeit beträgt, soweit nicht anders angegeben, 5-10 Werktage. Da alle Produkte handgefertigt sind, kann die Lieferzeit variieren.</p>
              
              <p className="mt-4">4.4 Der Verkäufer versendet die Ware mit DHL oder GLS. Die Auswahl des Versanddienstleisters obliegt dem Verkäufer.</p>
            </section>
            ...
            <section>
              ...
              <p className="mt-4">8.3 Diese individuellen Unterschiede sind charakteristisch für handgefertigte Produkte und stellen keinen Mangel dar.</p>
            </section>
