...
function CheckoutForm() {
  ...
  const [selectedCarrier] = useState<'dhl' | 'gls'>('dhl');
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sticky top-24">
                ...
                >
                  ...
                  <div className="relative bg-gradient-to-br from-rose-200 via-rose-300 to-rose-400 py-4 rounded-full shadow-xl border border-rose-400/30 flex items-center justify-center gap-2">
                    {loading ? (
                      <>
                      ...
                      <>
                        ...
                        <span className="text-lg font-semibold text-gray-800">Pay {t.common.currency}{total.toFixed(2)}</span>
                      </>
                    )}
                  </div>
                </button>
