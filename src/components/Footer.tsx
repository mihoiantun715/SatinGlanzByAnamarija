      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/privacy" className="text-sm hover:text-rose-400 transition-colors">Privacy Policy</Link></li>
              <li><Link href="/terms" className="text-sm hover:text-rose-400 transition-colors">Terms & Conditions</Link></li>
              <li><Link href="/imprint" className="text-sm hover:text-rose-400 transition-colors">Impressum</Link></li>
              <li><Link href="/refund-policy" className="text-sm hover:text-rose-400 transition-colors">Refund Policy</Link></li>
            </ul>
          </div>
