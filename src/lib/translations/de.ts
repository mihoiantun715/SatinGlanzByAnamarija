...
export const de: Translation = {
  ...
  home: {
    ...
    aboutText: 'Jede Rose wird von Anamarija Marković sorgfältig aus hochwertigem Satinstoff handgefertigt. Jedes Blütenblatt wird mit akribischer Liebe zum Detail geformt, gefaltet und zusammengesetzt.',
  ...
  about: {
    ...
    storyText1: 'Anamarija Marković hat vor Kurzem ihre Leidenschaft für die Herstellung von Satinrosen entdeckt und ein neues Hobby schnell in eine wunderschöne Kunstform verwandelt. Was als kreativer Funke begann, entwickelt sich bereits zu einer wachsenden Marke für exquisite handgefertigte Blumenarrangements.',
  ...
  footer: {
    ...
    madeWith: 'Mit ♥ gefertigt von Anamarija Marković — SatinGlanz',
  },
  bouquetBuilder: {
